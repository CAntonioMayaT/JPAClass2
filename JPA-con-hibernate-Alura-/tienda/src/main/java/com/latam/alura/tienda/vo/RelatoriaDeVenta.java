...
public class RelatoriaDeVenta {
	private String nombreDelProducto;
	private Long cantidadDeProducto;
	private LocalDate fechaDeUltimaVenta;
	
	public RelatoriaDeVenta(String nombreDelProducto, Long cantidadDeProducto, LocalDate fechaDeUltimaVenta) {
	...
	public String toString() {
		return "RelatoriaDeVenta [nombreDelProducto=" + nombreDelProducto + ", cantidadDeProducto=" + cantidadDeProducto
